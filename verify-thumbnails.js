...
console.log(
  `Videos with Thumbnails: ${videosWithThumbnails} (${((videosWithThumbnails / totalVideos) * 100).toFixed(1)}%)`
)
console.log(
  `Videos without Thumbnails: ${videosWithoutThumbnails} (${((videosWithoutThumbnails / totalVideos) * 100).toFixed(1)}%)`
)
