...
const sampleNotifications = [
  {
    ...
    content:
      'AlgoView provides step-by-step visualizations of popular algorithms. Start learning today!',
    type: 'announcement',
    priority: 'high',
    active: true,
    views: 0,
  ...
  },
  {
    ...
    content:
      "We've launched a comprehensive binary tree visualizer with support for BST, AVL, and more. Check it out in the DSA section!",
    type: 'update',
    priority: 'high',
    active: true,
    views: 0,
  ...
  },
  {
    ...
    content:
      "We'll be performing important system updates. The platform will be temporarily unavailable during this time. Thank you for your patience!",
    type: 'maintenance',
    priority: 'medium',
    active: true,
    views: 0,
  ...
  },
  {
    ...
    content:
      'Unlock advanced visualizations, offline access, and ad-free experience. Use code ALGO50 at checkout.',
    type: 'discount',
    priority: 'medium',
    active: true,
    views: 0,
  ...
  },
  {
    ...
    content:
      'Check out our latest blog post on dynamic programming. From memoization to tabulation, we cover everything you need to know.',
    type: 'update',
    priority: 'low',
    active: true,
    views: 0,
...
async function setupNotifications() {
  try {
    ...
    for (const notification of sampleNotifications) {
      ...
      count++
      console.log(
        `✅ Added notification ${count}/${sampleNotifications.length}: ${notification.title}`
      )
    }
    ...
    console.log(
      '   ✏️  Fields: title, message, content, type, priority, active, views, clicks, createdAt, updatedAt'
    )
    console.log('\n🎯 Next Steps:')
