...
const urlMappings = {
  useContext:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseContext.jpg?alt=media',
  useMemo:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseMemo.jpg?alt=media',
  useCallback:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseCallback.jpg?alt=media',
  useRef:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseRef.jpg?alt=media',
  useAsync:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseAsync.jpg?alt=media',
  useEffect:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Freact%2FuseEffect.jpg?alt=media',
  promises:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Fjavascript%2Fpromises.jpg?alt=media',
  'async-await':
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Fjavascript%2Fasync-await.jpg?alt=media',
  decorators:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Fpython%2Fdecorators.jpg?alt=media',
  generators:
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/tutorials%2Fpython%2Fgenerators.jpg?alt=media',
  'lru-cache':
  ...
  'rate-limiter':
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/code-examples%2Fsystem-design%2Frate-limiter.jpg?alt=media',
  'binary-search':
    'https://firebasestorage.googleapis.com/v0/b/algorithm-visualizer-b963c.appspot.com/o/code-examples%2Falgorithms%2Fbinary-search.jpg?alt=media',
}
...
function createCustomMapping() {
  ...
  const template = {
    ...
    example_firebase_url:
      'https://firebasestorage.googleapis.com/v0/b/PROJECT_ID.appspot.com/o/tutorials%2Freact%2Fimage.jpg?alt=media',
    mappings: {
      useContext:
        'https://firebasestorage.googleapis.com/v0/b/YOUR_PROJECT.appspot.com/o/your-image-url',
      useMemo:
        'https://firebasestorage.googleapis.com/v0/b/YOUR_PROJECT.appspot.com/o/your-image-url',
      promises:
        'https://firebasestorage.googleapis.com/v0/b/YOUR_PROJECT.appspot.com/o/your-image-url',
