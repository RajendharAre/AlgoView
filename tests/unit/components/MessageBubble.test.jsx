  ...
  describe('Rendering', () => {
    ...
    it('renders HTML content properly for assistant messages', () => {
      const htmlMessage = {
        ...
        role: 'assistant',
        content:
          '<p><strong>Bold text</strong> and <em>italic text</em></p><ul><li>Item 1</li><li>Item 2</li></ul>',
        createdAt: new Date(),
      }
  ...
  describe('User vs Assistant Differentiation', () => {
    it('applies user-specific styling classes', () => {
      ...
      const { container } = render(
        <MessageBubble message={userMessage} onCopy={mockHandlers.onCopy} />
      )
    ...
    it('applies assistant-specific styling classes', () => {
      ...
      const { container } = render(
        <MessageBubble message={assistantMessage} onCopy={mockHandlers.onCopy} />
      )
