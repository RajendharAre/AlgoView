...
describe('ChatWindow Component', () => {
  ...
  describe('Message Display', () => {
    it('renders empty state when no messages', () => {
      render(<ChatWindow messages={[]} onCopy={mockHandlers.onCopy} />)
    ...
    it('renders messages when provided', () => {
      ...
      render(<ChatWindow messages={messages} onCopy={mockHandlers.onCopy} />)

      // Should render both messages
      expect(screen.getByText('Hello, explain merge sort')).toBeInTheDocument()
      expect(
        screen.getByText('Merge Sort is a divide and conquer algorithm...')
      ).toBeInTheDocument()
    })
    ...
    it('renders messages in correct order', () => {
      ...
      const { container } = render(<ChatWindow messages={messages} onCopy={mockHandlers.onCopy} />)
      ...
      const messageTexts = Array.from(messageElements).map(
        el => within(el).getByText(/message/i).textContent
      )
  ...
  describe('Loading States', () => {
    it('shows typing indicator when isLoading is true', () => {
      render(<ChatWindow messages={[]} isLoading={true} onCopy={mockHandlers.onCopy} />)
    ...
    it('shows typing indicator when isSending is true', () => {
      render(<ChatWindow messages={[]} isSending={true} onCopy={mockHandlers.onCopy} />)
    ...
    it('shows messages along with typing indicator when both present', () => {
      ...
      render(<ChatWindow messages={messages} isLoading={true} onCopy={mockHandlers.onCopy} />)
  ...
  describe('Auto-scroll Functionality', () => {
    it('scrolls to bottom when new messages are added', async () => {
      const { rerender } = render(<ChatWindow messages={[]} onCopy={mockHandlers.onCopy} />)

      // Add messages and re-render
      const messagesWithContent = [testUtils.testFixtures.messages.userMessage]
      rerender(<ChatWindow messages={messagesWithContent} onCopy={mockHandlers.onCopy} />)
  ...
  describe('Edge Cases', () => {
    it('handles null messages array gracefully', () => {
      render(<ChatWindow messages={null} onCopy={mockHandlers.onCopy} />)
    ...
    it('handles undefined messages array gracefully', () => {
      render(<ChatWindow messages={undefined} onCopy={mockHandlers.onCopy} />)
    ...
    it('handles very large number of messages', () => {
      ...
      render(<ChatWindow messages={manyMessages} onCopy={mockHandlers.onCopy} />)
    ...
    it('handles messages with special characters', () => {
      ...
      render(<ChatWindow messages={[specialMessage]} onCopy={mockHandlers.onCopy} />)
    ...
    it('handles rapid message updates', async () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        rerender(<ChatWindow messages={messages} onCopy={mockHandlers.onCopy} />)
      }
  ...
  describe('Performance', () => {
    it('efficiently renders large message lists', () => {
      const largeMessageSet = Array(50)
        .fill()
        .map((_, i) => ({
          id: `msg-${i}`,
          role: i % 2 === 0 ? 'user' : 'assistant',
      ...
      render(<ChatWindow messages={largeMessageSet} onCopy={mockHandlers.onCopy} />)
    ...
    it('memoizes message rendering for unchanged messages', () => {
      ...
      const { rerender } = render(<ChatWindow messages={messages} onCopy={mockHandlers.onCopy} />)
  ...
  describe('Visual Elements', () => {
    it('applies correct styling classes', () => {
      const { container } = render(<ChatWindow messages={[]} onCopy={mockHandlers.onCopy} />)
