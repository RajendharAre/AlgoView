...
describe('Header Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with custom title and subtitle', () => {
      render(<Header title="Custom AI Title" subtitle="Custom Subtitle" />)
  ...
  describe('Clear Functionality', () => {
    ...
    it('disables clear button when disabled prop is true', () => {
      render(<Header onClear={mockHandlers.onClear} disabled={true} />)
    ...
    it('clear button has proper aria-label based on disabled state', () => {
      const { rerender } = render(<Header onClear={mockHandlers.onClear} disabled={false} />)

      let clearButton = screen.getByLabelText('Clear chat')
      expect(clearButton).toBeInTheDocument()

      rerender(<Header onClear={mockHandlers.onClear} disabled={true} />)
  ...
  describe('Edge Cases', () => {
    ...
    it('maintains layout with varying content lengths', () => {
      const { rerender } = render(<Header title="Short" subtitle="Brief" />)
