...
describe('ChatInput Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with default placeholder when not provided', () => {
      render(
        <ChatInput value="" onChange={mockHandlers.onChange} onSubmit={mockHandlers.onSubmit} />
      )
  ...
  describe('Auto-resize Functionality', () => {
    it('textarea resizes based on content length', async () => {
      ...
      await user.type(
        textarea,
        'This is a very long message that should cause the textarea to resize and accommodate multiple lines of content.'
      )
