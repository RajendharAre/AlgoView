  ...
  describe('New User Journey', () => {
    it('completes full new user experience', async () => {
      ...
      vi.mock('../../../src/pages/AI/utils/responseGenerator', () => ({
        generateResponse: vi
          .fn()
          .mockResolvedValue('Welcome to our AI assistant! This is a helpful response.'),
      }))
      ...
      expect(
        screen.getByText('Welcome to our AI assistant! This is a helpful response.')
      ).toBeInTheDocument()
  ...
  describe('Complete Conversation Flow', () => {
    it('maintains context through multi-turn conversation', async () => {
      ...
      for (const message of messages) {
        ...
        expect(
          screen.getByText(new RegExp(`Understood. You said: "${message}"`))
        ).toBeInTheDocument()
      }
