...
export const bellmanFordInfo = {
  ...
  description:
    'Finds shortest paths from a source vertex to all other vertices in a weighted graph, even with negative edge weights. Can detect negative cycles.',
  complexity: {
    time: {
      worst: 'O(VE)',
      average: 'O(VE)',
  ...
  timeComplexity: {
    ...
    worst: 'O(VE)',
    explanation:
      'Relaxes edges V-1 times to find shortest paths. Each relaxation pass: O(E). Total: O(VE). Best case: no updates needed after first pass.',
  },
  spaceComplexity: {
    value: 'O(V)',
