...
export const floydWarshallInfo = {
  ...
  timeComplexity: {
    ...
    worst: 'O(V³)',
    explanation:
      'Three nested loops over V vertices for each intermediate vertex. Must check all paths: O(V³) regardless of input.',
  },
  spaceComplexity: {
    value: 'O(V²)',
    explanation:
      'Stores distance matrix of size V×V containing shortest path distances between all pairs.',
  },
  applications: [
  ...
  disadvantages: ['Cubic time complexity', 'Not suitable for sparse graphs'],
}
