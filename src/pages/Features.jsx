...
const coreFeatures = [
  {
    ...
    description:
      'Step-wise execution for sorting, searching, graph, and dynamic programming with live controls and algorithm insights.',
    icon: Blocks,
  },
  {
    title: 'AI Learning Companion',
    description:
      'Context-aware assistant for quick concept explanations, debugging support, and interview-style guidance.',
    icon: Brain,
  },
  {
    title: 'Practice And Tracking',
    description:
      'Structured problem practice with progress metrics that help users measure consistency and growth.',
    icon: TrendingUp,
  },
  {
    title: 'Developer Learning Hub',
    description:
      'Tutorials, code examples, Q and A, and community resources collected in one practical flow.',
    icon: BookOpen,
  },
  {
    title: 'Collaborative Idea Space',
    description:
      'Create, explore, and refine project ideas with an integrated community feedback loop.',
    icon: Users,
  },
  {
    title: 'Scalable Product Foundation',
    description:
      'Clean architecture and reusable components that make feature expansion straightforward.',
    icon: Code2,
  },
]
...
const FeaturesHeroIllustration = () => (
  ...
  >
    ...
    <polyline
      points="411,271 415,276 423,263"
      stroke="#3b82f6"
      strokeWidth="2.2"
      strokeLinecap="round"
      strokeLinejoin="round"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 relative">
          <div className="lg:grid lg:grid-cols-2 lg:gap-14 lg:items-center">
            ...
            >
              ...
              >
                AlgoView combines algorithm understanding, implementation practice, and modern
                development learning into a single, consistent workflow.
              </p>
              ...
              {productPillars.map((pillar, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h4 className="font-bold text-base mb-1" style={{ color: COLORS.text.primary }}>
                      {pillar.title}
                    </h4>
      ...
      <section className="py-14 sm:py-16 border-t" style={{ borderColor: COLORS.border.light }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p
              className="text-sm sm:text-base max-w-2xl mx-auto mb-7"
              style={{ color: COLORS.border.medium }}
            >
              Start using AlgoView to structure your DSA journey, sharpen implementation quality,
              and keep your development growth consistent.
            </p>
