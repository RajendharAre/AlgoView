  ...
  const teamMembers = [
    {
      ...
      avatar:
        'https://res.cloudinary.com/dsx4notov/image/upload/v1775970940/Rajendhar_Cropped_icbbpb.png',
      ...
      <div className="py-16" style={{ backgroundColor: COLORS.bg.surface }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Empowering developers and students to master algorithms through interactive
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center mb-8">
            <div
              className="p-1 rounded-lg flex flex-wrap justify-center gap-1"
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <p className="mb-4" style={{ color: COLORS.text.secondary }}>
                      Founded in 2023, AlgoView began as a passion project to help students and
                      developers understand complex algorithms through interactive visualization.
                      What started as a simple concept has grown into a comprehensive platform
                      serving thousands of users worldwide.
                    </p>
                    <p className="text-gray-600 mb-4">
                      Our platform combines cutting-edge visualization technology with educational
                      best practices to create an engaging learning experience that makes algorithm
                      comprehension accessible to everyone.
                    </p>
                  </div>
                  <div
              ...
              <div className="space-y-6">
                ...
                <div className="prose max-w-none">
                  <p className="mb-4" style={{ color: COLORS.text.secondary }}>
                    ...
                    becoming a great developer. Our mission is to democratize computer science
                    education by making complex algorithms accessible, understandable, and enjoyable
                    for everyone.
                  </p>
                  <p className="text-gray-600 mb-4">
                    We strive to create an environment where learners can experiment, make mistakes,
                    and grow at their own pace. Through interactive visualizations, comprehensive
                    explanations, and practical exercises, we aim to bridge the gap between
                    theoretical knowledge and practical application.
                  </p>
                  <div
                    className="p-6 rounded-lg mt-6 border"
                    style={{
                      backgroundColor: COLORS.bg.tertiary,
                      borderColor: COLORS.border.light,
                    }}
                  >
                    ...
                    <p style={{ color: COLORS.text.secondary }}>
                      To become the world's leading platform for algorithm education, empowering
                      millions of developers to excel in their careers and contribute to
            ...
            {activeTab === 'team' && (
              <div className="space-y-6">
                ...
                <p className="mb-8" style={{ color: COLORS.text.secondary }}>
                  The developer behind AlgoView, passionate about making algorithm education
                ...
                <div className="flex justify-center">
                  {teamMembers.map((member, index) => (
                    <div
                      key={index}
                      className="border rounded-lg p-8 text-center transition-shadow max-w-md"
                      style={{
                        backgroundColor: COLORS.bg.surface,
                        borderColor: COLORS.border.light,
                        boxShadow: SHADOWS.sm,
                ...
                >
                  ...
                  <p className="mb-4" style={{ color: COLORS.text.secondary }}>
                    AlgoView is a passion project created to help students and developers master
                    algorithms through interactive visualization. Built with modern web technologies
                    and a focus on user experience, it combines education with innovation.
                  </p>
                  <p className="mb-6" style={{ color: COLORS.text.secondary }}>
                    If you have feedback, suggestions, or would like to collaborate, feel free to
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <a
                      href="https://github.com/RajendharAre/algorithm-visualizer"
                      target="_blank"
                      rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto" style={{ color: COLORS.bg.secondary }}>
              Have questions or feedback? We'd love to hear from you and help improve your learning
              experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: COLORS.bg.surface }}>
                Email Us
              </h3>
