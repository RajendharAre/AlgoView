...
const DSA = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Show sidebar only for algorithm routes */}
      {showSidebar && (
        <>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
          <div className="flex items-center">
            {/* Show hamburger menu on mobile or when sidebar is collapsed AND showing sidebar */}
            {showSidebar && (
              <button
                type="button"
            ...
            {/* Show heading only for algorithm routes */}
            {showSidebar ? (
