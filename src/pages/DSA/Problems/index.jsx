...
const DSAProblems = () => {
  ...
  const problemSheets = [
    { id: 'all', name: 'All Problems', count: 1200 },
    {
      ...
      name: 'Striver Sheet',
      count: 184,
      description: 'Curated by Raj Vikramaditya (Striver)',
    ...
    },
    {
      ...
      count: 450,
      description: 'Popular problem sheet for interview prep',
    ...
    },
    {
      ...
      name: 'NeetCode 150',
      count: 150,
      description: 'Curated by NeetCode for coding interviews',
      url: 'https://leetcode.com/problem-list/plakya4j/',
    },
    {
      id: 'blind-75',
      name: 'Blind 75',
      ...
      url: 'https://leetcode.com/problem-list/oizxjoit/',
    },
    {
      id: 'apna-college',
      name: 'Apna College',
      count: 200,
      description: 'DSA sheet from Apna College YouTube channel',
      url: 'https://docs.google.com/spreadsheets/d/1hXserPuxVoWMG9Hs7y8wVdRCJTcj3xMBAEYUOXQ5Xag/edit?pli=1&gid=0#gid=0',
    },
  ]
    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Practice problems from popular sheets used by top tech companies
        </p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="text-gray-600">Select a sheet to view its problems</div>
