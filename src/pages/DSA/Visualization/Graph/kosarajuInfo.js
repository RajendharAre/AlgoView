...
const kosarajuInfo = {
  ...
  description:
    'Finds all strongly connected components in a directed graph using two passes of depth-first search on the original graph and its transpose.',
  ...
  timeComplexity: {
    ...
    worst: 'O(V + E)',
    explanation:
      'First DFS on original graph: O(V+E). Graph transpose: O(V+E). Second DFS on transposed graph: O(V+E). Total: O(V+E).',
  },

  spaceComplexity: {
    value: 'O(V + E)',
    explanation:
      'Stores finishing stack, call stack for DFS recursion, transposed graph, and SCC component groups.',
  },
