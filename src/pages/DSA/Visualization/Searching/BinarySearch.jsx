    ...
    <div className="flex flex-col-reverse md:flex-row min-h-screen md:h-screen bg-[#f8f9faff] text-[#212529] font-sans overflow-auto md:overflow-hidden">
      ...
      <main className="flex-1 flex flex-col bg-[#f8f9faff] relative overflow-hidden min-h-[300px] md:min-h-0">
        ...
        <div className="absolute top-10 left-1/2 -translate-x-1/2 text-center z-10">
          <p className="text-[10px] font-black uppercase text-[#adb5bd] mb-2 tracking-[0.2em]">
            Searching For
          </p>
          ...
          <div className="flex flex-wrap justify-center items-start gap-x-4 gap-y-8 max-w-5xl transition-all duration-500">
            {array.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex flex-col items-center min-w-[64px] transition-all duration-500"
                >
                  ...
                  <div className="h-10 flex flex-col items-center justify-end mb-2 w-full">
                    {isMid && (
                      <div className="flex flex-col items-center animate-bounce">
                        ...
                        <span className="text-[7px] font-black bg-[#212529] text-white px-1.5 py-0.5 rounded leading-none uppercase tracking-tighter">
                          Mid
                        </span>
                      </div>
                    )}
                  ...
                  <div className="h-14 flex flex-col items-center mt-1 w-full">
                    {!isMatched && (isLow || isHigh) && (
                      <div
                        className={`flex flex-col items-center transition-opacity duration-300 ${shouldFade ? 'opacity-20' : 'opacity-100'}`}
                      >
                    ...
                    <span
                      className={`text-[8px] font-bold text-[#adb5bd] uppercase tracking-tighter mt-1 ${shouldFade ? 'opacity-10' : 'opacity-100'}`}
                    >
                      idx {idx}
                    </span>
                  </div>
