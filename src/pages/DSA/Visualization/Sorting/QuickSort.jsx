      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-12 bg-[#f8f9faff] relative min-h-[300px] md:min-h-0">
        ...
        <div className="mb-12 flex gap-4 absolute top-20 left-1/2 -translate-x-1/2">
          <div className="flex items-center gap-2 px-3 py-1 bg-white border border-[#dee2e6] rounded-full shadow-sm">
            ...
            <span className="text-[9px] font-bold text-[#6c757d] uppercase tracking-wider">
              Pointer I (Smaller)
            </span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1 bg-white border border-[#dee2e6] rounded-full shadow-sm">
            <div className="w-2 h-2 rounded-full bg-[#adb5bd]"></div>
            <span className="text-[9px] font-bold text-[#adb5bd] uppercase tracking-wider">
              Pointer J (Scanning)
            </span>
          </div>
        </div>
            ...
            return (
              <div key={idx} className="flex flex-col items-center gap-4">
                ...
                <div className="flex flex-col items-center h-4">
                  ...
                  {!isPivot && isI && (
                    <div className="text-[10px] font-black text-[#6c757d]">I</div>
                  )}
                  {!isPivot && isJ && (
                    <div className="text-[10px] font-black text-[#adb5bd]">J</div>
                  )}
                </div>
              </div>
            )
          ...
          items={[
            {
              ...
              label: 'Active Pivot',
              icon: <Target size={10} className="text-white" />,
            },
