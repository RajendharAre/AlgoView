              ...
              return (
                <div
                  ...
                  className={`absolute -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full flex items-center justify-center text-sm font-black transition-all duration-500 shadow-md border-2
                                ${
                                  isSwapping
                                    ? 'bg-[#212529] text-white border-[#212529] scale-125 z-10'
                                    : isComparing
                                      ? 'bg-[#6c757d] text-white border-[#6c757d] scale-110'
                                      : 'bg-white border-[#dee2e6]'
                                }`}
                  style={{ left: pos.x, top: pos.y }}
                >
                  {val}
                  <div className="absolute -bottom-6 text-[8px] font-bold text-[#adb5bd]">
                    i:{i}
                  </div>
                </div>
              )
