    ...
    <div className="flex flex-col-reverse md:flex-row min-h-screen md:h-screen bg-[#f8f9faff] text-[#212529] font-sans overflow-auto md:overflow-hidden">
      ...
      <main className="flex-1 flex flex-col bg-[#f8f9faff] relative overflow-hidden min-h-[300px] md:min-h-0">
        ...
        <div className="p-8 border-b border-[#dee2e6] bg-white">
          <p className="text-center text-[9px] font-black uppercase text-[#adb5bd] mb-4 tracking-[0.2em]">
            Source / Final Array
          </p>
        ...
        <div className="flex-1 p-8 flex flex-col items-center">
          <p className="text-center text-[9px] font-black uppercase text-[#adb5bd] mb-6 tracking-[0.2em]">
            Buckets Partition
          </p>
          ...
          <div className="flex gap-4 w-full max-w-5xl justify-center h-full max-h-64">
            {buckets.map((bucket, bIdx) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex-1 bg-white rounded-t-2xl border-2 border-b-0 p-3 flex flex-col gap-2 overflow-y-auto
                  ...
                  <div
                    className={`py-2 text-center text-[10px] font-black uppercase rounded-b-xl border-2 border-t-0
