...
export function TypingIndicator({ text = 'AI is thinking...' }) {
  return (
    <div
      className="flex items-start gap-3 px-4 py-3 max-w-3xl mx-auto"
      role="status"
      aria-live="polite"
    >
      {/* Avatar */}
      <div
        className="flex-shrink-0 w-8 h-8 rounded-md bg-gray-100 dark:bg-gray-700 flex items-center justify-center flex-shrink-0"
      ...
      <div className="flex-1 py-1">
        <div className="text-sm text-gray-500 dark:text-gray-400 font-medium">{text}</div>
