              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      isEditing && setUser(prev => ({ ...prev, name: e.target.value }))
                    }
                    readOnly={!isEditing}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      isEditing && setUser(prev => ({ ...prev, website: e.target.value }))
                    }
                    readOnly={!isEditing}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      isEditing && setUser(prev => ({ ...prev, location: e.target.value }))
                    }
                    readOnly={!isEditing}
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={
                      isEditing ? socialProfiles.leetcode : user?.socialProfiles?.leetcode || ''
                    }
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={
                      isEditing ? socialProfiles.linkedin : user?.socialProfiles?.linkedin || ''
                    }
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={
                      isEditing ? socialProfiles.hackerrank : user?.socialProfiles?.hackerrank || ''
                    }
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={
                      isEditing ? socialProfiles.codechef : user?.socialProfiles?.codechef || ''
                    }
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value={
                      isEditing ? socialProfiles.codeforces : user?.socialProfiles?.codeforces || ''
                    }
