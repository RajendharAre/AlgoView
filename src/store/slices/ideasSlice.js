...
// Async thunks
export const fetchIdeas = createAsyncThunk('ideas/fetchIdeas', async (_, { rejectWithValue }) => {
  try {
...
export const deleteIdea = createAsyncThunk('ideas/deleteIdea', async (id, { rejectWithValue }) => {
  try {
