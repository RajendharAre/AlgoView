...
export const documentationConfig = [
  // React Documentation
  {
    ...
    category: 'React',
    description:
      'Understanding React components, JSX syntax, and component lifecycle. Learn functional components and hooks.',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'React',
    description:
      'Master useState, useEffect, useContext, useReducer, and custom hooks. Build stateful components efficiently.',
  ...
  },
  {
    ...
    category: 'React',
    description:
      'Optimize renders with useMemo, useCallback, memo. Understand reconciliation and key strategies.',
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'React',
    description:
      'Write unit and integration tests for React components. Best practices and testing patterns.',
    difficulty: 'Intermediate',
  ...
  // JavaScript Documentation
  {
    ...
    category: 'JavaScript',
    description:
      'Arrow functions, destructuring, spread operator, async/await. Modern JavaScript essentials.',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'JavaScript',
    description:
      'Callbacks, Promises, async/await. Handle asynchronous operations and error handling.',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'JavaScript',
    description:
      'Understanding lexical scope, closures, and the scope chain. Common pitfalls and best practices.',
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'JavaScript',
    description:
      'Prototype chain, Object creation patterns, and class syntax. Master object-oriented JavaScript.',
    difficulty: 'Advanced',
    docUrl:
  ...
  },
  {
    ...
    category: 'Node.js',
    description:
      'Build REST APIs with Express. Routing, middleware, error handling, and authentication.',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'Node.js',
    description:
      'Working with streams for efficient data processing. File operations and best practices.',
    difficulty: 'Advanced',
  ...
  // Firebase Documentation
  {
    ...
    category: 'Firebase',
    description:
      'Implement user authentication. Email/password, social login, and user management.',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'Firebase',
    description:
      'Cloud Firestore for real-time data storage. Collections, documents, queries, and security rules.',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'Firebase',
    description:
      'Write security rules for Firestore and Storage. Protect user data and enforce access control.',
    difficulty: 'Advanced',
  ...
  // Data Structures Documentation
  {
    ...
    description:
      'Understand arrays, dynamic arrays, and list operations. Time and space complexity analysis.',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'Data Structures',
    description:
      'Tree structures, BSTs, AVL trees, and traversal methods (in-order, pre-order, post-order).',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'Data Structures',
    description:
      'Hash functions, collision resolution, and hash table implementation. O(1) lookups.',
    difficulty: 'Intermediate',
  ...
  },
  {
    ...
    category: 'Algorithms',
    description:
      'Linear search, binary search, and advanced search techniques. Optimal implementation.',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    category: 'Algorithms',
    description:
      'Greedy approach, activity selection, Huffman coding, and Kruskal/Prim algorithms.',
    difficulty: 'Intermediate',
  ...
  // System Design Documentation
  {
    ...
    description:
      'Horizontal/vertical scaling, load balancing strategies, and distributed systems basics.',
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'System Design',
    description:
      'Cache invalidation, Redis, CDNs, and caching patterns. LRU, TTL, and consistency.',
    difficulty: 'Advanced',
  ...
  },
  {
    ...
    category: 'Web Development',
    description:
      'Utility-first CSS. Rapid UI development, responsive utilities, and customization.',
    difficulty: 'Intermediate',
