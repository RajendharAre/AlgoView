...
export const SchemaMarkup = () => {
  ...
  const organizationSchema = {
    ...
    "sameAs": [
      "https://twitter.com/algoview",
      "https://github.com/algoview"
    ],
    "contactPoint": {
      "@type": "ContactPoint",
  ...
  const webAppSchema = {
    ...
    "description": "Learn data structures and algorithms visually with interactive step-by-step animations",
  ...
  const educationalSchema = {
    ...
    "url": "https://algovieww.me",
    "description": "Interactive platform to learn data structures and algorithms through visual animations",
    "about": {
      "@type": "Thing",
