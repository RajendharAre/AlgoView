  ...
  if (showForgotPassword) {
    return (
      <div className="w-full h-full flex flex-col">
        ...
        <form onSubmit={handleForgotPassword} className="space-y-4 flex-1 flex flex-col justify-center">
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 disabled:bg-gray-400 transition-colors flex items-center justify-center"
          >
            {loading ? (
              <>
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 disabled:bg-gray-400 transition-all duration-300 flex items-center justify-center shadow-sm hover:shadow-md"
        >
          {loading ? (
            <>
              <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-2"></div>
