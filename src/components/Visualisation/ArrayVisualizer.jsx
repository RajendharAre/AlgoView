...
const ArrayVisualizer = ({
  ...
  if (array.length === 0) {
    return (
      <div
        className={`w-full h-44 sm:h-64 md:h-96 flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-3xl ${className}`}
      >
  ...
  return (
    <div
      className={`w-full max-w-5xl h-44 sm:h-64 md:h-96 flex items-end gap-0.5 sm:gap-1 md:gap-1.5 px-2 sm:px-4 md:px-8 ${className}`}
    >
      {array.map((value, idx) => {
